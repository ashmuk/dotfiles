...
"
" Last Change: 06-May-2025 by Mukai to deal with MacVim.
...
" 端末モード関連の色設定
"highlight Terminal guifg=lightgrey guibg=grey20 "Comment out by Mukai
...
if has('win32')
  " Windows用
  set guifont=MyricaM_M:h12:cSHIFTJIS:qDRAFT " Added by Mukai
  if &guifont == ''
...
" ウインドウに関する設定:
"
" ウィンドウの位置 Added by Mukai
winpos 500 0
" ウインドウの幅
"set columns=80
set columns=200 "Added by Mukai
" ウインドウの高さ
"set lines=25
set lines=80 "Added by Mukai
" コマンドラインの高さ(GUI使用時)
set cmdheight=2
