...
# =====================
# Profile switching
# DEV_PROFILE = [default|js|sys]
PROFILE="${DEV_PROFILE:-default}"
SKIP_NODE=0; SKIP_RUST=0; SKIP_CPP=0; SKIP_PYDATA=0
case "$PROFILE" in
  js)   SKIP_RUST=1; SKIP_CPP=1 ;;
  sys)  SKIP_NODE=1; SKIP_PYDATA=1 ;;
  *)    : ;;
esac
echo "[post-create] Using DEV_PROFILE=$PROFILE (SKIP_NODE=$SKIP_NODE, SKIP_RUST=$SKIP_RUST, SKIP_CPP=$SKIP_CPP, SKIP_PYDATA=$SKIP_PYDATA)"
