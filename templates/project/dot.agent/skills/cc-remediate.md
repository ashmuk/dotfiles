...
## Purpose
Close the broken review feedback loop. Take reviewer findings, coordinate builder to apply fixes, then re-invoke reviewer to validate. This is the "Next" step from cc-review when MUST-FIX findings exist.
