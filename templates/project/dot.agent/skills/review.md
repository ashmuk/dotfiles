...
- Review is strictly read-only — no code modifications. All fixes flow through remediate skill to builder agent.
...
7. Next: If MUST-FIX findings exist, invoke remediate skill. Otherwise, accept.
